      ...
      <div className="relative group">
        ...
        >
          ...
          <TrashIcon
            ...
            className="size-3 shrink-0 text-red-500 absolute right-1 cursor-pointer transition-all"
          />
        </button>
      </div>
    );
          ...
          <>
            <DropdownMenu modal={false}>
              ...
              <DropdownMenuContent className="w-50">
                <DropdownMenuGroup>
                  <DropdownMenuItem onClick={() => addFile(node.id)}>
                    <FileIcon />
                    New File
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => addFolder(node.id)}>
                    <FolderIcon />
                    New Folder
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
